...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = InlineKeyboardMarkup( [ [ InlineKeyboardButton('🎬 ᴍᴏᴠɪᴇᴄʀᴀᴄᴋᴇʀ', url='https://t.me/MovieCrackerLinks') ] ] )
        ...
        try:
            if AUTH_CHANNEL and not await is_subscribed(client, query):
                ...
                await client.send_cached_media(
                    ...
                    file_id=file_id,
                    caption=f_caption,
                    reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('🎬 ᴍᴏᴠɪᴇᴄʀᴀᴄᴋᴇʀ', url='https://t.me/MovieCrackerLinks') ] ] ),
        ...
        m=await message.reply_sticker("CAACAgEAAxkBAAEGt-1jkDEkFqkC5ZA7OU70giV5Hv_jJgACKwIAAiJPIUQPPmWBMgN8AysE")
        ...
        await query.answer("I couldn't find anything related to that. Check your spelling", True)
...
async def auto_filter(client, msg, spoll=False):
    ...
    if imdb:
        ...
        cap = f"👋 𝖧𝖾𝗅𝗅𝗈 𝖳𝗁𝖾𝗋𝖾...!!!\n📁 𝖸𝗈𝗎𝗋 𝖥𝗂𝗅𝖾𝗌 𝖠𝗋𝖾 𝖱𝖾𝖺𝖽𝗒\n\n♨️ 𝖯𝗈𝗐𝖾𝗋𝖾𝖽 𝖡𝗒 @MovieCrackerLinks"
